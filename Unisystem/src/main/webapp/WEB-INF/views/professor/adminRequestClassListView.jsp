							...
							<tr>
								...
								<c:choose>
									<c:when test="${ empty c.classStatus }">
										<td><button class="btn btn-sm btn-primary detail" style="background:#0466C8;color:white;border:white;">대기</button></td>
									</c:when>
									<c:when test="${ c.classStatus eq 'Y' }">
										<td><button class="btn btn-sm btn-primary detail" style="background:#F8F7FF;color:black;border:white;">승인</button></td>
									</c:when>
									<c:otherwise>
										<td><button class="btn btn-sm btn-primary detail" style="background:#E2EAFC;color:black;border:white;">반려</button></td>
									</c:otherwise>
								</c:choose>
							</tr>
							</c:forEach>
						...
						<div align="center">
							<table class="table1 table table-bordered" style="width:1090px">
								<tr>
									...
									<td width="200px"><input class="input" id="year" name="classYear" maxlength="4" required></td>
	...
	<jsp:include page="../common/footer.jsp" />
			...
			$(function(){
				...
				$(".detail").on("click", function(){
					var cno = $(this).parent().siblings().eq(2).text();
					location.href="cdetail?classNo=" + cno;
				})
