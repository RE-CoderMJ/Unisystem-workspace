        ...
        <section>
        	<form method="post" enctype="multipart/form-data">
	            <header id="mail-boxes-header">
	                <div id="mailbox-name">내게 쓰기</div>
	                <br><br>
	                <button id="send-btn" type="submit" formaction="webMail.send"><i class="fas fa-arrow-right"></i>&nbsp;보내기</button>
	                <button id="draft-btn" type="submit" formaction="webMail.saveToMeDraft">임시저장</button>
	            </header>
	            <article>
	               <div id="mail-info">
	                    ...
	                    <span>받는 사람</span>
	                    <input id="write-to" type="text" name="userToNo" readonly value="${loginUser.userNo}@unisystem.com">
	                    <input id="write-cc" type="hidden" name="cc">
	                    <br><br>
	                    <span>제목</span>
	                    <input id="write-title" type="text" name="title" value=" ">
