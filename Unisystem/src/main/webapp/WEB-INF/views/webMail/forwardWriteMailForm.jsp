        	...
        	<form method="post" enctype="multipart/form-data">
	            ...
	            <article>
	               <div id="mail-info">
	                    ...
	                    <span>받는 사람</span>
	                    <input id="write-to" type="text" name="userToNo" required onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);">
	                    <br><br> 
	                    <span>참조</span>
	                    <input id="write-cc" type="text" name="cc" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);">
	                    <br><br>
	                    <span>제목</span>
	                    <input id="write-title" type="text" name="title" value="FW: ${mf.title}">
	                    <div id="contents-area">
	                    	<textarea id="summernote" name="content" style="margin-left:100px">
	                    		<br><br><br><br>
	                    		<hr><br>
	                    		----------------------- Original Message -----------------------<br>
	                    		<b>From :</b> "${mf.fromName }"<${mf.address}><br>
	                    		<b>To : </b> "${mf.userToName }"<${mf.userToNo}><br>
	                    		<b>Sent : </b> ${mf.sendDate}<br>
	                    		<b>Subject : </b> ${mf.title}
	                    		<br><br>
	                    		${mf.content}
	                    		<br><br>
