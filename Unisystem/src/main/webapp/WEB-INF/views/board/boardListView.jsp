...
<body>
	...
	<div class="bo_content">
			...
			<form id="searchForm" action="" method="get">
				<div class="select">
					<select name="condition" class="custom-select">
						<option class=" " value="4">카테고리</option>
						<option class=" " value="5">자유</option>
						<option class=" " value="6">취업</option>
						<option class=" " value="7">정보</option>
					</select>
				</div>
		...
		<div class="ctg-area">
			<button name="keyword" value="5">자유</button>
			<button name="keyword" value="6">취업</button>
			<button name="keyword" value="7">정보공유</button>
		</div>
