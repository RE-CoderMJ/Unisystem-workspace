...
<body>
	...
	<div style="background-color: rgb(235, 242, 252); width: 1500px;">
		...
		<div class="bo_content">
			...
			<div class="head_count msg_division">보낸 메시지 조회</div>
			...
			<div class="btn-area">
				<a class="btn btn-sm btn-danger" href="">선택삭제</a> <a class="btn btn-sm" href="" style="background-color:rgb(44, 62, 80); color:white;">쪽지보내기</a>
			</div>
